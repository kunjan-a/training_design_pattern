...
public class SunTestClient {
    ...
    public SunTestClient() {
        ...
        this.sun = new Sun();
        this.sun.registerForSunEvents(this.person);
        this.sun.registerForSunEvents(this.cat);
        this.sun.registerForSunEvents(this.dog);
        this.sun.registerForSunEvents(this.robot);
    }
