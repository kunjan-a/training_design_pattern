...
import designpattern.adapter.thirdparty.LeaveRecord;
...
public class AdapterTest {
    ...
    public void testGetDisplayWallOfShame() throws Exception {
        FrontDoorRegister frontDoorRegister = new FrontDoorRegister(new LeaveRecordAdapter(new LeaveRecord()));
    ...
    public void salaryDisbersmentTest() {
      SalaryDisberser salaryDisberser = new SalaryDisberser(new LeaveRecordAdapter(new LeaveRecord()));
